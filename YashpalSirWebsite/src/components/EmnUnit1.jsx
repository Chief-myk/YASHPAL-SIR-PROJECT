...
import EmnUnit2 from "./EmnUnit2";

const EmnUnit1 = () => {
  const [pdfFiles, setPdfFiles] = useState([
    { name: "1.1.1 BASICS OF MECHANICS.pdf", url: "/assests/EML/unit1/1.1.1 BASICS OF MECHANICS.pdf" },
    { name: "1.1.2 Force System.pdf", url: "/assests/EML/unit1/1.1.2 Force System.pdf" },
    { name: "1.1.3 Principle of Transmissibility.pdf", url: "/assests/EML/unit1/1.1.3 Principle of Transmissibility.pdf" },
    { name: "1.1.4 Resultant of Forces System.pdf", url: "/assests/EML/unit1/1.1.4 Resultant of Forces System.pdf" },
    { name: "1.1.5 RESOLUTION OF FORCES.pdf", url: "/assests/EML/unit1/1.1.5 RESOLUTION OF FORCES.pdf" },
    { name: "1.1.6 Moment of force.pdf", url: "/assests/EML/unit1/1.1.6 Moment of force.pdf" },
    { name: "1.1.7 VARIGNON THEOREM.pdf", url: "/assests/EML/unit1/1.1.7 VARIGNON THEOREM.pdf" },
    { name: "1.1.8 couple.pdf", url: "/assests/EML/unit1/1.1.8 couple.pdf" },
    { name: "1.1.9 BEAM BASICS.pdf", url: "/assests/EML/unit1/1.1.9 BEAM BASICS.pdf" },
    { name: "1.2 FRRE BODY DIAGRAM.pdf", url: "/assests/EML/unit1/1.2 FRRE BODY DIAGRAM.pdf" },
    { name: "1.2.1 FBD NUMERICALS.pdf", url: "/assests/EML/unit1/1.2.1 FBD NUMERICALS.pdf" },
    { name: "1.3 Centre of Gravity.pdf", url: "/assests/EML/unit1/1.3 Centre of Gravity.pdf" },
    { name: "1.4 Moment of inertia.pdf", url: "/assests/EML/unit1/1.4 Moment of inertia.pdf" },
    { name: "1.4.1 Moment of inertia Numerical.pdf", url: "/assests/EML/unit1/1.4.1 Moment of inertia Numerical.pdf" },
        ...
        {pdfFiles.length > 0 ? (
          <>
            ...
            <div className="w-full h-[65vh] bg-gray-800 rounded-xl overflow-hidden shadow-xl">
              <iframe
               key={pdfFiles[currentPdfIndex]?.url}  
