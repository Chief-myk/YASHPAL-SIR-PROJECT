...
const Workshop = () => {
  const [pdfFiles, setPdfFiles] = useState([
    { name: "maintenance.pdf", url: "/assests/Workshop/maintenance.pdf" },
    { name: "manual.pdf", url: "/assests/Workshop/manual.pdf" },
    { name: "precaution.pdf", url: "/assests/Workshop/precaution.pdf" },
  ]);
