...
import EmnUnit3 from "./EmnUnit3";

const EmnUnit2 = () => {
  const [pdfFiles, setPdfFiles] = useState([
    { name: "2.1 Structure (Truss) notes.pdf", url: "/assests/EML/unit2/2.1 Structure (Truss) notes.pdf" },
    { name: "friction in pivot and collar bearing.pdf", url: "/assests/EML/unit2/friction in pivot and collar bearing.pdf" },
    { name: "friction notes.pdf", url: "/assests/EML/unit2/friction notes.pdf" },
    { name: "friction.pdf", url: "/assests/EML/unit2/friction.pdf" },
    { name: "Truss numerical DS KUMAR.pdf", url: "/assests/EML/unit2/Truss numerical DS KUMAR.pdf" },
  ]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex flex-col items-center p-6">
      <div className="w-full max-w-6xl">
        ...
        <p className="text-gray-300 text-center mb-8">Unit 2 - Study Materials</p>
