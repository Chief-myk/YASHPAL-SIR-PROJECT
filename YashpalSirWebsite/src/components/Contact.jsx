...
const ContactCard = ({ icon, title, text, isClickable = false }) => {
  return (
    <motion.div
      className={`flex flex-col items-center bg-gradient-to-br from-gray-900 to-gray-950 p-6 rounded-xl shadow-lg text-center transition-all duration-300 h-full group border border-gray-700 ${
        isClickable
...
const Contact = () => {
  ...
  const socialPlatforms = [
    {
      name: "linkedin",
      url: "https://www.linkedin.com/in/yashpal-chopra-27ab0340/",
    },
    // { name: "twitter", url: "#" },
    // { name: "facebook", url: "#" },
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            I'm passionate about mentoring students and helping them shape their
            future. Whether you need academic guidance, research collaboration,
            or professional advice, feel free to reach out. I typically respond
            within 24-48 hours.
          </motion.p>
        </motion.div>
