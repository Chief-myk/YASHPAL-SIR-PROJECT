...
const EmnUnit3 = () => {
  const [pdfFiles, setPdfFiles] = useState([
    { name: "3.1 kinematics of Particles.pdf", url: "/assests/EML/unit3/3.1 kinematics of Particles.pdf" },
    { name: "3.2 kinetics of Particles.pdf", url: "/assests/EML/unit3.pdf/3.2 kinetics of Particles" },
    { name: "3.3 Impact of Bodies.pdf", url: "/assests/EML/unit3.pdf/3.3 Impact of Bodies" },
  ]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex flex-col items-center p-6">
      <div className="w-full max-w-6xl">
        ...
        <p className="text-gray-300 text-center mb-8">Unit 3 - Study Materials</p>
