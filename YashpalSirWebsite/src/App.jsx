      ...
      <div className="flex flex-col min-h-screen bg-gray-50">
        ...
        <main className="flex-grow transition-all duration-300">
          <Routes>
            ...
            <Route path="/emn/unit-2" element={<EmnUnit1 />} />  
            <Route path="/emn/unit-3" element={<EmnUnit1 />} />  
            <Route path="/emn/unit-4" element={<EmnUnit1 />} />  
            <Route path="/mpl/unit-1" element={<MplUnit1 />} />  
            <Route path="/mpl/unit-2" element={<MplUnit1 />} />  
            <Route path="/mpl/unit-3" element={<MplUnit1 />} />  
            <Route path="/mpl/unit-4" element={<MplUnit1 />} />  
          </Routes>
        </main>
        <Footbar />
      </div>
